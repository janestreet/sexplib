...
val bigstring_sexp_grammar : bigstring Sexplib0.Private.Raw_grammar.t
...
val float32_vec_sexp_grammar : float32_vec Sexplib0.Sexp.Private.Raw_grammar.t
...
val float64_vec_sexp_grammar : float64_vec Sexplib0.Sexp.Private.Raw_grammar.t
...
val vec_sexp_grammar : vec Sexplib0.Sexp.Private.Raw_grammar.t

(** [vec_of_sexp sexp] same as {!float64_vec_of_sexp}. *)
val vec_of_sexp : Sexp.t -> vec

val float32_mat_sexp_grammar : float32_mat Sexplib0.Sexp.Private.Raw_grammar.t
...
val float64_mat_sexp_grammar : float64_mat Sexplib0.Sexp.Private.Raw_grammar.t
...
val mat_sexp_grammar : mat Sexplib0.Sexp.Private.Raw_grammar.t
