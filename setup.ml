...
(* OASIS_START *)
(* DO NOT EDIT (digest: d218b723aa482d307fab3871448603eb) *)
(*
...
(* # 21 "/home/ysulsky/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "]^\"\208\150\029w\238\227\136\213\185\155.k\147";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
