(* OASIS_START *)
(* DO NOT EDIT (digest: 2a3fe5c1f745767a4e6e880b6e146165) *)
(*
...
(* # 21 "/mnt/local/sda1/jdimino/plop/4.01.0dev+short-paths/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "4\143{e}\149\249\028\137\253tL'\131j@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
