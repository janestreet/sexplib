...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1966b91311c729f6f395707dda62ade6) *)
(*
...
(* # 21 "/tmp/oasis-0.3.0~rc5/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_digest =
       Some "\026A/\006\224\197\204\220\019\005\235\174\143x\244\131";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
