(* OASIS_START *)
(* DO NOT EDIT (digest: 87611761e2d26fc76d2828851cf05f63) *)
(*
...
(* # 21 "/mnt/local/sda1/jdimino/dot-opam/4.01.0dev+short-paths/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\004QM%\226\027F\150\200\255\025\241\203\133\139s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
