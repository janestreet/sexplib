(* OASIS_START *)
(* DO NOT EDIT (digest: 9ea0a8b6ac9fe773a4d7f930ad081d6a) *)
(*
...
(* # 21 "/home/jdimino/.opam/4.01.0dev+short-paths/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "=\217N\022G\254\1784%\185\229\247\157\020n\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
